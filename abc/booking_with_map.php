...
<nav class="navbar navbar-dark bg-dark">
  <a class="navbar-brand" href="landing.html">
    <img src="logo3.png" width="30" height="30" class="d-inline-block align-top" ><strong>CabIT</strong></a>
</nav>
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
       ...
       <li class="nav-item active">
        <a class="nav-link" href="booking.html"><i class="fas fa-car"></i><strong> BOOK NOW <span class="sr-only">(current)</span></strong></a>
      </li>
...
<div class="container">
 <div class="row  ">
  ...
  <label class="form-check-label" for="exampleRadios1">Mini</label>
</div>
<hr>
<div class="form-check">
  <input class="form-check-input" type="radio" name="exampleRadios" >
  <label class="form-check-label" for="exampleRadios2">Micro</label>
</div>
<hr>
<div class="form-check ">
  <input class="form-check-input" type="radio" name="exampleRadios" >
  <label class="form-check-label" for="exampleRadios3">Sedan</label>
</div>
<hr>
<div class="form-check ">
  <input class="form-check-input" type="radio" name="exampleRadios" >
...
<div class="last">
 &copy; CabIT 2022. All Rights Reserved.
